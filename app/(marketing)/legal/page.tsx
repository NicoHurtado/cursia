        ...
        <main className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
          <header className="mb-8">
            ...
            <div className="mt-3 rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
              ...
              <p>
                <b>
                  Todo el contenido de Cursia es tercero, no es de nuestra
                  autoría o verificable, nosotros somos una herramienta para
                  acercar el contenido público a las personas.
                </b>
                Cursia no es una fuente citable ya que el contenido proviene de
                la IA y no de fuentes verificadas.
              </p>
            </div>
            <div className="mt-3 rounded-lg border border-slate-200 bg-white p-4 text-sm text-slate-700">
              ...
              <p>
                ...
                políticas de contenido, propiedad intelectual, privacidad y
                pagos aplicables a tu uso de Cursia (la "Plataforma"). Es un
          ...
          <section id="quienes" className="mt-8 space-y-4">
            ...
            <p>
              "Cursia" es una plataforma educativa que permite generar cursos
              personalizados con apoyo de modelos de inteligencia artificial.
          ...
          <section id="aceptacion" className="mt-8 space-y-4">
            ...
            <p>
              ...
              Política de Privacidad correspondiente. Si no estás de acuerdo,
              por favor no uses Cursia. Podremos actualizar estos Términos; el
              uso continuo implica aceptación de los cambios publicados.
            </p>
          </section>
          ...
          <section id="servicio" className="mt-8 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Funciones opcionales según plan: certificados, comunidad,
                soporte.
              </li>
              <li>
            ...
            <p className="text-sm text-slate-600">
              <b>No garantizamos</b> la exactitud, integridad o actualidad de
              los contenidos generados por IA. El material es referencial y debe
          ...
          <section id="uso" className="mt-8 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Publicar o solicitar contenido ilegal, difamatorio, fraudulento
                o que incite a la violencia.
              </li>
              <li>
              ...
              <li>
                Ingeniería inversa, scraping abusivo, spam, acceso no
                autorizado, elusión de seguridad.
              </li>
              <li>
          ...
          <section id="ia" className="mt-8 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                El contenido se genera automáticamente a partir de tus entradas
                y modelos de IA.
              </li>
              <li>
          ...
          <section id="pi" className="mt-8 space-y-4">
            ...
            <p>
              ...
              Todo el contenido generado proviene de fuentes públicas
              disponibles a través de modelos de inteligencia artificial.
            </p>
          </section>
          ...
          <section id="privacidad" className="mt-8 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Pagos gestionados por terceros (no almacenamos datos completos
                de tarjeta).
              </li>
              <li>
          ...
          <section id="pagos" className="mt-8 space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Puedes cancelar tu suscripción en cualquier momento; el acceso
                se mantiene hasta el fin del período pagado.
              </li>
            </ul>
          </section>
          ...
          <section id="garantias" className="mt-8 space-y-4">
            ...
            <p>
              Cursia se ofrece "<b>tal cual</b>" y "<b>según disponibilidad</b>
              ". No garantizamos que el servicio sea ininterrumpido, libre de
              errores o que el contenido generado cumpla objetivos específicos.
          ...
          <section id="disponibilidad" className="mt-8 space-y-4">
            ...
            <p>
              ...
              descontinuar funciones o planes en cualquier momento para mejorar
              el servicio o por razones operativas/legales. Intentaremos
              comunicar cambios relevantes con antelación razonable.
            </p>
          </section>
